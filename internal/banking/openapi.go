	...
	return httpserver.OpenAPIFragment{
		...
		Paths: map[string]any{
			...
			"/api/banking/payee-rules": map[string]any{
				"get": map[string]any{
					"tags":        []string{"banking"},
					"summary":     "List payee rules",
					"description": "Returns learned and manually-created payee categorisation rules for review and correction.",
					"operationId": "bankingListPayeeRules",
					"security":    bankingSessionSecurity(),
					"responses": map[string]any{
						"200": bankingJSONResponseRef("Payee rules", "BankingPayeeRulesResponse"),
						"401": bankingProblemResponse("Authentication required"),
					},
				},
				"post": map[string]any{
					"tags":        []string{"banking"},
					"summary":     "Create a payee rule",
					"operationId": "bankingCreatePayeeRule",
					"security":    bankingSessionSecurity(),
					"requestBody": bankingJSONRequestBodyRef("BankingPayeeRuleRequest"),
					"responses": map[string]any{
						"201": bankingJSONResponseRef("Payee rule created", "BankingPayeeRule"),
						"400": bankingProblemResponse("Malformed payee-rule request"),
						"401": bankingProblemResponse("Authentication required"),
						"413": bankingProblemResponse("Payee-rule request body is too large"),
						"422": bankingProblemResponse("Payee-rule validation failed"),
					},
				},
			},
			"/api/banking/payee-rules/{id}": map[string]any{
				"put": map[string]any{
					"tags":        []string{"banking"},
					"summary":     "Update a payee rule",
					"operationId": "bankingUpdatePayeeRule",
					"security":    bankingSessionSecurity(),
					"parameters":  []map[string]any{bankingIDPathParameter("id", "Payee rule ID.")},
					"requestBody": bankingJSONRequestBodyRef("BankingPayeeRuleRequest"),
					"responses": map[string]any{
						"200": bankingJSONResponseRef("Payee rule updated", "BankingPayeeRule"),
						"400": bankingProblemResponse("Malformed payee-rule request"),
						"401": bankingProblemResponse("Authentication required"),
						"404": bankingProblemResponse("Payee rule was not found"),
						"413": bankingProblemResponse("Payee-rule request body is too large"),
						"422": bankingProblemResponse("Payee-rule validation failed"),
					},
				},
				"delete": map[string]any{
					"tags":        []string{"banking"},
					"summary":     "Delete a payee rule",
					"operationId": "bankingDeletePayeeRule",
					"security":    bankingSessionSecurity(),
					"parameters":  []map[string]any{bankingIDPathParameter("id", "Payee rule ID.")},
					"responses": map[string]any{
						"204": map[string]any{"description": "Payee rule deleted"},
						"400": bankingProblemResponse("Malformed payee-rule ID"),
						"401": bankingProblemResponse("Authentication required"),
						"404": bankingProblemResponse("Payee rule was not found"),
					},
				},
			...
			"BankingPayeeRulesResponse": map[string]any{
				...
				"properties": map[string]any{
					"rules": map[string]any{
						"type":  "array",
						"items": map[string]any{"$ref": "#/components/schemas/BankingPayeeRule"},
					},
				},
				"additionalProperties": false,
			},
			"BankingPayeeRuleRequest": map[string]any{
				"type":     "object",
				"required": []string{"matcher", "match_mode", "account_code"},
				"properties": map[string]any{
