...
var (
	moduleDependencies = map[string]map[string]struct{}{
		...
		"app":          dependencySet("advisor", "dividends", "dla", "identity", "invoicing", "jurisdiction", "ledger", "moneyfx", "reports"),
		...
		"it":           dependencySet("advisor", "app", "dividends", "dla", "identity", "invoicing", "jurisdiction", "ledger", "moneyfx", "reports"),
